select file_server_location,
    file_google_drive_location,
    array_to_string( array_agg( distinct column_name ), ', ' ) as columns,
    coalesce( nullif( forms, '' ), 'Not Found' ) as forms
from (
...
group by file_server_location,
    file_google_drive_location,
    forms
order by file_google_drive_location,
    columns;